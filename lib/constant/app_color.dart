...
class AppColor {
  //Main Color
  final yueGuangLanMoonlight = const Color(0xFF5958b2); // Primary Color
  final coldSnow = const Color(0xFFFEF7FF); // Secondary Color
  ...
  final bleachedSilk = const Color(0xFFF2F2F2); // unselected button Color
  final doctor = const Color(0xFFF9F9F9); // unselected button 2 Color
